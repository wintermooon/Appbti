...
recruitcommentRouter.post(
  '/recruit/comment/create',
  loginRequired,
  async (req, res, next) => {
    try {
      /* #swagger.security = [{
...
recruitcommentRouter.get(
  '/recruit/usercommentlist/:user_id',
  loginRequired,
  async (req, res, next) => {
    try {
      /* #swagger.security = [{
...
recruitcommentRouter.get(
  '/recruit/boardcommentlist/:board_id',
  loginRequired,
  async (req, res, next) => {
    try {
      /* #swagger.security = [{
